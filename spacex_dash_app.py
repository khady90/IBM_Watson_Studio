...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df \
            .where(spacex_df['Launch Site'] == entered_site) \
            .groupby(['class'], dropna=True, as_index=False).count()
...
def get_scatter_plot(entered_site, payload):
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df.where(spacex_df['Launch Site'] == entered_site)\
            .groupby(['class', 'Booster Version Category'], dropna=True, as_index=False).count()
